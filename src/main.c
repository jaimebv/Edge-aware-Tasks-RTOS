...
/*===========================================================================*/
/* COMPONENT: Edge-aware Tasks RTOS - Task Manager                           */
/*===========================================================================*/
...
void task_sensor_client(void *pvParameters)
{
    ...
    while (1) {
        ...
        // Note: In real usage, use the handle or safe name
        //update_task_metrics_OE2EL("SensorTask-cl-0", 15); 
        ...
        if (eaPort_Queue_Receive(params->queue_server_client, &received_data, eaPort_WAIT_FOREVER) == eaPort_STATUS_OK) {
            ...
            /* Update Metrics */
            //update_task_metrics_OE2EL("SensorTask-sv-0", 5);
        }
    }
}
...
void app_main(void)
{
     ...
     * This should create TWO tasks: "SensorTask-cl-0" and "SensorTask-sv-0"
     */
